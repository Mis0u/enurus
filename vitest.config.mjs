...
export default defineConfig({
    resolve: {
        alias: {
            // 'html-to-image', 'sweetalert2' et 'canvas-confetti' ne sont chargés qu'en importmap
            // (AssetMapper), pas installés en npm : Vite ne peut pas les résoudre statiquement
            // sans ces alias vers des stubs de test (interceptables ensuite via vi.mock()).
            ...
            'canvas-confetti': fileURLToPath(new URL('./tests/js/stubs/canvas-confetti.js', import.meta.url)),
